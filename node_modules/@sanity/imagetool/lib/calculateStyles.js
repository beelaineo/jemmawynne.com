...
function calculateHotSpotCrop(sourceAspect, descriptor, spec) {
  ...
  var outImg = {
    ...
    width: 1 / netWidth,
    height: 1 / netHeight // The rational aspect is the aspect ration of the crop in ratios of the image size meaning the image
  ...
  var hotspot = {
    ...
    width: descriptor.hotspot.width / netWidth // Lets calculate the maximum scale the image may be presented at without cropping the hotspot. A scale of
