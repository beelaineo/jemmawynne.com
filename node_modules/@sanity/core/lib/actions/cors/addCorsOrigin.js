...
function _templateObject4() {
  var data = _taggedTemplateLiteral(["\n      Using wildcards can be ", ".\n      Are you ", " you want to allow this origin?"]);
...
function promptForCredentials(hasWildcard, context) {
  ...
  if (hasWildcard) {
    output.print(oneline(_templateObject(), chalk.yellow("".concat(logSymbols.warning, " Warning:")), chalk.red(chalk.underline('HIGHLY')), chalk.underline('on your behalf')));
  } else {
    output.print(oneline(_templateObject2(), chalk.yellow("".concat(logSymbols.warning, " Warning:")), chalk.underline('on your behalf')));
  }

  output.print('');
  return prompt.single({
    type: 'confirm',
    message: oneline(_templateObject3()),
    default: false
  });
}
...
function promptForWildcardConfirmation(origin, context) {
  ...
  return prompt.single({
    type: 'confirm',
    message: oneline(_templateObject4(), chalk.red('risky'), chalk.underline('absolutely sure')),
    default: false
  });
}
