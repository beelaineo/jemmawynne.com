...
var INVALID_PREVIEW_FALLBACK = {
  ...
  media: _warningIcon.default // Will track a memo of the value as long as the isActive$ stream emits true,
  // and emit the memoized value after it switches to to false
  // (disclaimer: there's probably a better way to do this)

};

var memoizeBy = isActive$ => producer$ => {
  var memo;
  return isActive$.pipe((0, _operators.distinctUntilChanged)(), (0, _operators.switchMap)(isActive => isActive ? producer$.pipe((0, _operators.tap)(v => memo = v)) : (0, _rxjs.of)(memo).pipe((0, _operators.filter)(Boolean))));
};
...
var connect = props$ => {
  ...
  }), (0, _observeForPreview.default)(props.value, props.type, props.fields, props.ordering ? {
