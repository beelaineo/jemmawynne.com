...
var error = (message, helpId, path) => createValidationResult('error', message, helpId);

exports.error = error;

var warning = (message, helpId, path) => createValidationResult('warning', message, helpId);

exports.warning = warning;

var info = (message, helpId, path) => createValidationResult('info', message, helpId);
