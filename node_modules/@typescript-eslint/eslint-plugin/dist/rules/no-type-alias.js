...
exports.default = util.createRule({
    ...
    create(context, [{ allowAliases, allowCallbacks, allowLiterals, allowMappedTypes }]) {
        ...
        function isCallback(node) {
            return node && node.type === experimental_utils_1.AST_NODE_TYPES.TSFunctionType;
        }
        /**
        ...
        function isLiteral(node) {
            return node && node.type === experimental_utils_1.AST_NODE_TYPES.TSTypeLiteral;
        }
        /**
        ...
        function isMappedType(node) {
            return node && node.type === experimental_utils_1.AST_NODE_TYPES.TSMappedType;
        }
        /**
