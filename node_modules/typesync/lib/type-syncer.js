 ...
 */
function createTypeSyncer(packageJSONService, typeDefinitionSource, packageSource, globber) {
    ...
    function syncFile(filePath, file, allTypings, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, allPackages, allPackageNames, newTypings, used, devDepsToAdd;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(newTypings.map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                var _a, typePackageInfoPromise, codePackageInfo, codePackage, closestMatchingCodeVersion, typePackageInfo, closestMatchingTypingsVersion, version, semverRangeSpecifier;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
