...
(0, _ava2.default)('returns empty object when called without params', t => {
	const actual = (0, _2.default)();
	t.deepEqual(actual, {});
});

(0, _ava2.default)('returns an equivalent object as passed in', t => {
	const expected = { foo: 'bar' };
	const actual = (0, _2.default)(expected);
	t.deepEqual(actual, expected);
});

_ava2.default.serial('falls back to global install', t => new Promise(function ($return, $error) {
	...
	return Promise.resolve(_test.fix.bootstrap('fixtures/global-install')).then(function ($await_1) {
		try {
			...
			npm = args => (0, _execa2.default)('npm', args, { cwd });
				...
				try {
					...
					return Promise.resolve(npm(['install', '--global', '@commitlint/config-angular', '--prefix', prefix])).then(function ($await_3) {
						try {
							...
							t.notThrows(() => (0, _2.default)(expected));
...
_ava2.default.serial('fails for missing extends', t => new Promise(function ($return, $error) {
	...
	return Promise.resolve(_test.fix.bootstrap('fixtures/missing-install')).then(function ($await_4) {
		try {
			...
			t.throws(() => (0, _2.default)(input, { cwd }), /Cannot find module "@commitlint\/foo-bar" from/);
...
(0, _ava2.default)('uses empty prefix by default', t => {
...
(0, _ava2.default)('uses prefix as configured', t => {
	const input = { extends: ['extender-name'] };
...
(0, _ava2.default)('ignores prefix for scoped extends', t => {
...
(0, _ava2.default)('adds prefix as suffix for scopes only', t => {
...
(0, _ava2.default)('ignores prefix for relative extends', t => {
...
(0, _ava2.default)('propagates return value of require function', t => {
	const input = { extends: ['extender-name'] };
	const propagated = { foo: 'bar' };

	const actual = (0, _2.default)(input, {
		resolve: id,
		require() {
			return propagated;
		}
...
(0, _ava2.default)('resolves extends recursively', t => {
	const input = { extends: ['extender-name'] };
	const actual = [];
...
(0, _ava2.default)('uses prefix key recursively', t => {
	const input = { extends: ['extender-name'] };
	const actual = [];
...
(0, _ava2.default)('propagates contents recursively', t => {
	const input = { extends: ['extender-name'] };
...
(0, _ava2.default)('propagates contents recursively with overlap', t => {
	const input = { extends: ['extender-name'] };
...
(0, _ava2.default)('extending contents should take precedence', t => {
...
(0, _ava2.default)('should fall back to conventional-changelog-lint-config prefix', t => {
	const input = { extends: ['extender-name'] };
