...
export const createGetOptionSwatches =
  (productInfo?: ProductInfo) =>
  (option: ShopifySourceProductOption): SwatchOption | null => {
...
export const createGetSwatchOptions =
  (productInfo?: ProductInfo) =>
  (product: ShopifyProduct): SwatchOption[] => {
...
export const createGetProductInfoBlocks =
  (productInfo?: ProductInfo) =>
  (product: ShopifyProduct): DefinitelyProductInfo[] => {
    if (!productInfo) return []
    const {
...
export const createGetTagBadges =
  (productInfo?: ProductInfo) =>
  (product: ShopifyProduct): TagBadge[] => {
    if (!productInfo) return []
